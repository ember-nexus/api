...
- API Endpoints
  ...
  - **Upload Endpoints**
    - [<span class="method-head">HEAD</span>` /upload/<uuid> -` Head Upload Endpoint](/api-endpoints/upload/head-upload)
    - [<span class="method-patch">PATCH</span>` /upload/<uuid> -` Patch Upload Endpoint](/api-endpoints/upload/patch-upload)
    - [<span class="method-delete">DELETE</span>` /upload/<uuid> -` Delete Upload Endpoint](/api-endpoints/upload/delete-upload)
  - **System Endpoints**
  ...
  - **Error Endpoints**
    ...
    - [<span class="method-get">GET</span>` /error/400/reserved-type -` Get Details for Error 400 Reserved Type Endpoint](/api-endpoints/error/get-400-reserved-type)
    ...
    - [<span class="method-get">GET</span>` /error/408/request-timeout -` Get Details for Error 408 Request Timeout Endpoint](/api-endpoints/error/get-408-request-timeout)
    ...
    - [<span class="method-get">GET</span>` /error/503/service-unavailable -` Get Details for Error 503 Service Unavailable Endpoint](/api-endpoints/error/get-503-service-unavailable)
