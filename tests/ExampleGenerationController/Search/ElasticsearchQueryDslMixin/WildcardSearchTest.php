...
class WildcardSearchTest extends BaseRequestTestCase
{
    ...
    {
        $path = \Safe\realpath(__DIR__.'/../../../../docs/search/example/elasticsearch-query-dsl-mixin/wildcard-search/request-payload.json');
