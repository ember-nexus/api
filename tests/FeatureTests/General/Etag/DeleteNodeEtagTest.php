...
class DeleteNodeEtagTest extends BaseRequestTestCase
{
    ...
    private const string UUID_DATA_1 = '55765f93-0373-48a7-89d1-4cb203827204';
    private const string UUID_DATA_2 = '407d6936-c871-4cb5-bd70-faa2c426ea1b';
    private const string UUID_DATA_3 = 'fb2b4efb-6a36-4681-92b1-65e593809c6b';
    ...
    public function testEtagBeforeAndAfterDeletingCentralNode(): void
    {
        ...
        $initialEtagNode1Children = $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_1, '/children', '"XovCNrKbfle"');
        $initialEtagNode1Related = $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_1, '/related', '"FZ6aqOLaiW5"');

        $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_2, '', '"YpnfkN4NVqq"');
        $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_2, '/parents', '"PQM1gARCGid"');
        $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_2, '/children', '"KNH6fLhOk5J"');
        $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_2, '/related', '"UD1sPlHH5nt"');

        $initialEtagNode3Self = $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_3, '', '"VnrkHEG5DdH"');
        $initialEtagNode3Parents = $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_3, '/parents', '"VoESTGuVvEJ"');
        $initialEtagNode3Children = $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_3, '/children', '"4PhJYUg8ISZ"');
        $initialEtagNode3Related = $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_3, '/related', '"VoESTGuVvEJ"');

        $initialEtagNode4Self = $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_4, '', '"TkVt26Dobi3"');
        $initialEtagNode4Parents = $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_4, '/parents', '"U5rj9sPDp03"');
        $initialEtagNode4Children = $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_4, '/children', '"ULOTh08uBbH"');
        $initialEtagNode4Related = $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_4, '/related', '"La7aCFnFhrJ"');

        $initialEtagNode5Self = $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_5, '', '"S07I2LP5XV8"');
        $initialEtagNode5Parents = $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_5, '/parents', '"UgIIjmuu5Qi"');
        $initialEtagNode5Children = $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_5, '/children', '"UPX8l4eSUGT"');
        $initialEtagNode5Related = $this->testEtagOfElement(self::TOKEN, self::UUID_DATA_5, '/related', '"6uEpSIAul6O"');
