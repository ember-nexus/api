 ...
 *     }>,
 * }
 * @psalm-type EmberNexusConfig = array{
 *     pageSize?: array{ // Affects how many elements can be returned in collection responses.
 *         min?: int|Param, // Minimum number of elements which are always returned, if they exist. // Default: 5
 *         default?: int|Param, // Default number of elements which are returned if they exist. // Default: 25
 *         max?: int|Param, // Maximum number of elements which are returned in a single response. Should not be way more than 100, as performance problems may arise. // Default: 100
 *     },
 *     register?: array{ // Handles the /register endpoint.
 *         enabled?: bool|Param, // If true, the /register endpoint is active and anonymous users can create accounts. // Default: true
 *         uniqueIdentifier?: scalar|null|Param, // The property name of the identifier. Identifier must be unique across the API, usually the email. // Default: "email"
 *         uniqueIdentifierRegex?: scalar|null|Param, // Either false or a regex for checking the identifier content. // Default: false
 *     },
 *     expression?: array{ // Configures settings related to the execution of expressions
 *         enabled?: bool|Param, // If true, expressions are executed. // Default: true
 *         warningLength?: int|Param, // Minimum length for executable expressions to trigger a warning in the logs. // Default: 512
 *         maxLength?: int|Param, // Maximum length for executable expressions. Exceeding the limit will throw an exception. // Default: 10240
 *     },
 *     instanceConfiguration?: array{ // Configures the /instance-configuration endpoint.
 *         enabled?: bool|Param, // If true, enables the endpoint. If false, 403 error messages are returned. // Default: true
 *         showVersion?: bool|Param, // If false, the version number is omitted. // Default: true
 *     },
 *     token?: array{ // Configures token settings.
 *         minLifetimeInSeconds?: int|Param, // Minimum lifetime of created tokens. // Default: 1800
 *         defaultLifetimeInSeconds?: int|Param, // Default lifetime of created tokens. // Default: 10800
 *         maxLifetimeInSeconds?: scalar|null|Param, // Maximum lifetime of created tokens. Can be set to false to disable maximum limit. // Default: 34214400
 *         tokenDeleteExpiredTokensAutomaticallyInSeconds?: scalar|null|Param, // Expired tokens will be deleted after defined time. Can be set to false to disable auto delete feature. // Default: 1209600
 *     },
 *     cache?: array{ // Configures the cache.
 *         etagSeed?: scalar|null|Param, // Seed used to generate Etag values. Changing it invalidates all data cached by clients. // Default: ""
 *         etagUpperLimitInCollectionEndpoints?: scalar|null|Param, // Maximum number of items in a collection for which to generate Etags. Bigger collection do not contain Etags due to performance problems. // Default: 100
 *     },
 ...
 *         uploadMinChunkSizeInBytes?: int|Param, // Minimum size in bytes of uploaded chunks. // Default: 0
 ...
 *         S3StorageBucket?: scalar|null|Param, // Name of the S3 bucket used for storage of files. // Default: "api-storage"
 *         S3UploadBucket?: scalar|null|Param, // Name of the S3 bucket used for temporary storage of uploads. // Default: "api-upload"
